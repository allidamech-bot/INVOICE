// v89 — complete offline shell with network-first app runtime, real iPhone PDF-file sharing/saving, and mobile pull-to-refresh.
...
const CACHE = 'lourex-invoice-v89';
