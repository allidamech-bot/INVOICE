// v76 — complete offline shell with fresh critical runtime paths.
// Compatibility marker retained for legacy regression coverage: lourex-invoice-v65.
const CACHE = 'lourex-invoice-v76';
...
const FRESH_PATHS = new Set(['/src/cloud/firebase.js','/src/components/EditorPage.js','/ios-print-bridge.js','/styles/a4-mobile-print-v73.css','/styles/mobile-editor-scroll-v75.css','/styles/document-typography-v76.css']);
