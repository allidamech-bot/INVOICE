...
(() => {
  ...
  const ensureInlineOverlay = (mode = pendingMode) => {
    ...
    style.textContent = '.lourex-ios-output-fallback{position:fixed;inset:0;z-index:2147483646;display:grid;place-items:center;padding:max(24px,env(safe-area-inset-top)) max(18px,env(safe-area-inset-right)) max(24px,env(safe-area-inset-bottom)) max(18px,env(safe-area-inset-left));background:rgba(0,0,0,.82);font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Arial,sans-serif}.lourex-ios-output-card{width:min(360px,100%);padding:24px;border:1px solid #333;border-radius:14px;background:#141414;color:#F0EFEA;text-align:center;box-shadow:none}.lourex-ios-output-card strong{display:block;font-size:18px;margin:8px 0;color:#F0EFEA}.lourex-ios-output-card span{display:block;color:#AAA9A4;font-size:13px;line-height:1.55;margin-bottom:18px}.lourex-ios-output-spinner{width:42px;height:42px;margin:0 auto 14px;border:2px solid #333;border-top-color:#B8A071;border-radius:50%;animation:lourexOutputSpin .8s linear infinite}.lourex-ios-output-card button,.lourex-ios-output-card a{min-height:46px;border-radius:9px;border:1px solid #383838;background:#1A1A1A;color:#F0EFEA;padding:0 16px;font:700 14px -apple-system,BlinkMacSystemFont,"Segoe UI",Arial,sans-serif}.lourex-ios-output-card a{display:flex;align-items:center;justify-content:center;text-decoration:none}.lourex-ios-output-primary{width:100%;background:#B8A071!important;background-image:none!important;border-color:#B8A071!important;color:#11110F!important;margin-bottom:8px;box-shadow:none!important}.lourex-ios-output-secondary{width:100%;margin-bottom:8px}.lourex-ios-output-error{color:#FF9A92!important}@keyframes lourexOutputSpin{to{transform:rotate(360deg)}}@media print{.lourex-ios-output-fallback{display:none!important}}';
