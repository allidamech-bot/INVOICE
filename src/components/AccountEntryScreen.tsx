...
export class AccountEntryScreen extends React.Component<Props,State>{
  ...
  private submit=async(e:any):Promise<void>=>{
    ...
    try{
      ...
      this.setState({message:create?t('Account created. Preparing LOUREX…','تم إنشاء الحساب. جارٍ تجهيز LOUREX…'):t('Signed in. Opening LOUREX…','تم تسجيل الدخول. جارٍ فتح LOUREX…')});
