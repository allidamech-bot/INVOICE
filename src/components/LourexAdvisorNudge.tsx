...
export class LourexAdvisorNudge extends React.Component<Props,State>{
  ...
  render():any{
    return this.state.visible?<aside className="lourex-advisor-nudge ta-advisor-nudge" role="status" dir={this.props.language==='ar'?'rtl':'ltr'} data-tailadmin-owner="ai-nudge-v320">
