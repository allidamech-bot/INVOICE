...
export type IconName = 'plus'|'home'|'settings'|'search'|'file'|'users'|'items'|'save'|'download'|'share'|'copy'|'trash'|'edit'|'lock'|'x'|'chevronDown'|'chevronUp'|'arrowLeft'|'printer'|'check'|'more'|'eye'|'upload'|'backup'|'restore'|'refresh'|'invoice'|'proforma'|'menu'|'sun'|'moon'|'system'|'chart'|'wallet'|'spark'|'star';
...
const paths: Record<IconName, any> = {
  ...
  search:<g><circle cx="10.8" cy="10.8" r="6.8"/><path d="m16 16 4.2 4.2"/></g>, file:<g><path d="M6.5 2.75h7l4 4V21.25h-11z"/><path d="M13.5 2.75v4.5H18M9.5 12h5M9.5 16h5"/></g>, users:<g><circle cx="9" cy="8" r="3.25"/><path d="M3.5 20v-1.2A4.8 4.8 0 0 1 8.3 14h1.4a4.8 4.8 0 0 1 4.8 4.8V20M16 5.2a3.15 3.15 0 0 1 0 5.6M17 14.2a4.7 4.7 0 0 1 3.5 4.6V20"/></g>, items:<g><path d="m4 7.5 8-4 8 4-8 4z"/><path d="m4 7.5 8 4 8-4V17l-8 4-8-4zM12 11.5V21M8 5.5l8 4"/></g>,
  ...
  check:<g><path d="m5 12 4 4L19 6"/></g>, more:<g><circle cx="5" cy="12" r="1.25" fill="currentColor" stroke="none"/><circle cx="12" cy="12" r="1.25" fill="currentColor" stroke="none"/><circle cx="19" cy="12" r="1.25" fill="currentColor" stroke="none"/></g>, eye:<g><path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7S2 12 2 12Z"/><circle cx="12" cy="12" r="3"/></g>, upload:<g><path d="M12 16V4m0 0L7 9m5-5 5 5"/><path d="M5 20h14"/></g>, backup:<g><path d="M20 7v5h-5M4 17v-5h5"/><path d="M6.1 8.5A7 7 0 0 1 18.9 7L20 12M4 12l1.1 5A7 7 0 0 0 17.9 15.5"/></g>, restore:<g><path d="M4 10a8 8 0 1 1 2.35 7.65"/><path d="M4 4v6h6M12 8v4l3 2"/></g>, refresh:<g><path d="M20 11a8 8 0 0 0-14.9-4L3 10M4 13a8 8 0 0 0 14.9 4L21 14"/><path d="M3 4v6h6M21 20v-6h-6"/></g>, invoice:<g><path d="M6.5 2.75h8l3 3V21.25h-11z"/><path d="M14.5 2.75v3.5H18M9.5 10.5h5M9.5 14h5M9.5 17.5h3"/></g>, proforma:<g><rect x="3.5" y="4" width="17" height="16" rx="2.5"/><path d="M7.5 8h9M7.5 12h6M7.5 16h4"/></g>, menu:<g><path d="M4 6h16M4 12h16M4 18h16"/></g>,
  sun:<g><circle cx="12" cy="12" r="3.5"/><path d="M12 2v2M12 20v2M4.93 4.93l1.42 1.42M17.65 17.65l1.42 1.42M2 12h2M20 12h2M4.93 19.07l1.42-1.42M17.65 6.35l1.42-1.42"/></g>,
  moon:<g><path d="M20.4 15.2A8.5 8.5 0 0 1 8.8 3.6 8.5 8.5 0 1 0 20.4 15.2Z"/></g>,
  system:<g><rect x="3" y="4" width="18" height="13" rx="2"/><path d="M8 21h8M12 17v4"/></g>,
