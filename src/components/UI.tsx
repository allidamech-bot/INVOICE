...
const paths: Record<IconName, any> = {
  ...
  check:<g><path d="m5 12 4 4L19 6"/></g>, alert:<g><path d="M10.3 3.8 2.8 17a2 2 0 0 0 1.75 3h14.9a2 2 0 0 0 1.75-3L13.7 3.8a2 2 0 0 0-3.4 0Z"/><path d="M12 9v4M12 17h.01"/></g>, more:<g><circle cx="5" cy="12" r="1.25" fill="currentColor" stroke="none"/><circle cx="12" cy="12" r="1.25" fill="currentColor" stroke="none"/><circle cx="19" cy="12" r="1.25" fill="currentColor" stroke="none"/></g>, eye:<g><path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7S2 12 2 12Z"/><circle cx="12" cy="12" r="3"/></g>, upload:<g><path d="M12 16V4m0 0L7 9m5-5 5 5"/><path d="M5 20h14"/></g>, backup:<g><path d="M20 7v5h-5M4 17v-5h5"/><path d="M6.1 8.5A7 7 0 0 1 18.9 7L20 12M4 12l1.1 5A7 7 0 0 0 17.9 15.5"/></g>, restore:<g><path d="M4 10a8 8 0 1 1 2.35 7.65"/><path d="M4 4v6h6M12 8v4l3 2"/></g>, refresh:<g><path d="M20 11a8 8 0 0 0-14.9-4L3 10M4 13a8 8 0 0 0 14.9 4L21 14"/><path d="M3 4v6h6M21 20v-6h-6"/></g>, invoice:<g><path d="M6.5 2.75h8l3 3V21.25h-11z"/><path d="M14.5 2.75v3.5H18M9.5 10.5h5M9.5 14h5M9.5 17.5h3"/></g>, proforma:<g><rect x="3.5" y="4" width="17" height="16" rx="2.5"/><path d="M7.5 8h9M7.5 12h6M7.5 16h4"/></g>, menu:<g><path d="M4 6h16M4 12h16M4 18h16"/></g>,
