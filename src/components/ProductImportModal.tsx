      ...
      <div className={`product-import-shell stage-${stage}`}>
        {stage==='pick'?<>
          ...
          <div className="product-import-safety-grid">
            ...
            <div><Icon name="refresh"/><span><strong>{t('Smart column matching','مطابقة ذكية للأعمدة')}</strong><small>{t('Common supplier and commercial spreadsheet headings are recognized automatically.','يتم التعرف تلقائيًا على عناوين الأعمدة الشائعة في ملفات الموردين والملفات التجارية.')}</small></span></div>
