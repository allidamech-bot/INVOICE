import type { AppSettings, CompanySettings, Customer, DocumentItem, LourexDocument, PaymentRecord, PaymentTermPreset, SavedItem, TemplateId } from '../types.js';
