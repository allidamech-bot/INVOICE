...
export class EditorPage extends React.Component<Props,State>{
  ...
  private selectCustomer=(c:Customer)=>{this.mutate(d=>applyCustomerCommercialDefaults({...d,customerSnapshot:customerSnapshotFrom(c)},c,this.props.company));this.setState({customerQuery:(isArabic()?c.companyNameAr:c.companyNameEn)||c.companyNameEn||c.companyNameAr,customerOpen:false});};
