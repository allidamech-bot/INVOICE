  ...
  render():any{
    ...
    return <div className={`editor-screen workflow-${workflow} ${this.state.mobilePreview?'mobile-preview-open':''}`} aria-busy={this.state.issuing}>
      <header className="editor-topbar">
        ...
        <div className="editor-grand-total-chip"><span>{isPurchaseOrder?t('Order Total','إجمالي الطلب'):t('Grand Total','الإجمالي')}</span><strong>{formatMoney(totals.grandTotal,d.currency)}</strong></div>
