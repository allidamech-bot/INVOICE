...
test('v177 loads after all application mobile recovery layers, before document output, and remains shipped after later PWA generations',async()=>{
  ...
  assert.match(sw,/^const CACHE = 'lourex-invoice-v178';$/m);
