...
test('v173 masks Safari native tablet date text behind the locale-safe Gregorian label',async()=>{
...
test('v173 balances iPad steps and keeps the compact action dock touch-safe',async()=>{
...
test('v173 ships through a fresh immutable PWA cache generation',async()=>{
