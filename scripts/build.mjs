...
if(vercelEnvironment!=='production'){
  ...
  for(const file of ['template-visual-qa.html','template-visual-qa.js','obsidian-foundation.html','obsidian-shell.html','obsidian-dashboard.html','obsidian-documents.html']){
