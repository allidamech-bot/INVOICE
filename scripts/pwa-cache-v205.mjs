...
const activeCacheGeneration=Number(activeCacheMatch?.[1]||0);
if(!Number.isInteger(activeCacheGeneration)||activeCacheGeneration<280)throw new Error('Unable to verify the active LOUREX PWA cache generation.');
