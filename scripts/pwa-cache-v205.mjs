...
if(!sw.includes("const CACHE = 'lourex-invoice-v225';"))throw new Error('Unable to advance the LOUREX PWA cache generation to v225.');
...
if(!sw.includes('await self.skipWaiting();'))throw new Error('Unable to enable the critical v225 service-worker activation.');
